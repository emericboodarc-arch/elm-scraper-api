...
    """Extrait les cards en gerant les navigations inattendues de Pages Jaunes."""
    results = []
    try:
...
                    continue
    except Exception:
        return results  # navigation en cours — retourne vide proprement
...
            })
        except Exception:
            continue  # card invalide apres navigation — on passe
    return results
